...
class ProductSimilarityMulti(QDialog):
    def __init__(self, parent=None):
        super(ProductSimilarityMulti, self).__init__(parent)
        ...
        self.setWindowTitle("Product Name Similarity % - Multiple")
...
if __name__ == '__main__':
    ...
    gallery = ProductSimilarityMulti()
    gallery.show()
    sys.exit(app.exec())